...
\begin{figure}[H]
\centering
\includegraphics[width=0.60\textwidth]{figures/f01_customer_layout.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=1.00\textwidth]{figures/f04_demand_distribution.png}
\caption{客户聚合需求分布特征}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{figures/f02_pace_profile.png}
\caption{三时段速度/配速}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{figures/allflow.png}
\caption{本文总流程图}
\label{fig:allflow}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{figures/f10_q1_fleet_usage.png}
\caption{各车型启用情况}
\label{fig:q1-fleet}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.70\textwidth]{figures/f08_q1_cost_breakdown.png}
\caption{问题一总成本明细拆解}
\label{fig:q1-cost}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.78\textwidth]{figures/f03_arc_penetration.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/f12_q1_vs_q2_cost.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/f11_q2_routes.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figures/f16_sensitivity_efleet.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figures/f17_sensitivity_tornado.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figures/f18_pareto_cost_vs_co2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.70\textwidth]{figures/f19_mc_cost_distribution.png}
